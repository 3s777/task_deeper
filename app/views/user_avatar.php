<?php $this->layout('layout_users', ['title' => 'Редактировать аватар пользователя']) ?>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="/user_update_avatar/<?php echo $user['id']; ?>" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                <div class="form-group">
                                    <img src="<?php echo $path; ?>" alt="" class="img-responsive" width="200">
                                </div>
