<?php $this->layout('layout_users', ['title' => 'Редактировать данные безопасности пользователя']) ?>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="/user_update_security/<?php echo $user['id']; ?>" method="POST">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" id="simpleinput" name="confirm_password" class="form-control">
                                </div>
